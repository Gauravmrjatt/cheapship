...
export const createOrderSchema = z.object({
  ...
  weight: z.number().min(100, "Weight is required").max(1000000, "Weight cannot exceed 1000000g (1000kg)"),
  length: z.number().min(1, "Length is required"),
  width: z.number().min(1, "Width is required"),
  height: z.number().min(1, "Height is required"),
...
export const courierRateInputSchema = z.object({
  ...
  weight: z.number().min(1, "Weight is required").max(1000000, "Weight cannot exceed 1000000g (1000kg)"),
  cod: z.boolean(),
