...
import { Menu05Icon, PanelRightOpenIcon, PanelLeftCloseIcon } from "@hugeicons/core-free-icons"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {isMobile ? <HugeiconsIcon icon={Menu05Icon} strokeWidth={2} /> : <HugeiconsIcon icon={(state == "collapsed") ? PanelLeftCloseIcon : PanelRightOpenIcon} strokeWidth={2} />}
